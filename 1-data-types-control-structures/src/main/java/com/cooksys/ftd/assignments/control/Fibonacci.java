...
public class Fibonacci {
     ...
     */
    public static long atIndex(int i) throws IllegalArgumentException {
        ...
        if (i<0){
        	...
        	long result = (long) ((Math.pow(Phi, (i+1))-Math.pow(phi, (i+1)))/Math.sqrt(5));
     ...
     */
    public static long[] slice(int start, int end) throws IllegalArgumentException {
    	int range = end - start;
    	long[] vec = new long [0];
     ...
     */
    public static long[] fibonacci(int count) throws IllegalArgumentException {
    	long[] vec = new long [0];
    	if (count<0) {
    		throw new IllegalArgumentException();
    	} else{
